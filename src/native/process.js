...
process.stdin.on('data', (data) => {
 const input = data.toString().trim().toLowerCase(); if (input === 'salir') {     console.log('Comando de salida recibido');     process.exit(0); } else {     console.log(`Mensaje: ${input}`);     console.log('Escribe "salir" para terminar');&#x20; }
});
